          ...
          <div className={styles.right}>
            <div className={styles.about_me}>
              ...
              <p className={styles.lead}>
                ...
                in for clean code, responsive design, and staying up-to-date with the latest web tech trends.
              </p>
              <p className={styles.lead}>
                Let&apos;s chat about your next web project! Together, we can create something amazing. 😄
              </p>
            </div>
          </div>
        </div>
